...
const OwnerSidebar: React.FC = () => {
  ...
  return (
    <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
      <div className="flex flex-col flex-grow pt-5 bg-[#f2fdff] overflow-y-auto border-r border-[#261e67]">
        <div className="flex items-center flex-shrink-0 px-4">
          <h1 className="text-xl font-bold text-[#001140]">AI Scheduler</h1>
        </div>
        ...
        <div className="flex-shrink-0 flex border-t border-[#261e67] p-4">
